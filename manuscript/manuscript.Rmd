...
```{r chla_micro_scatter, echo=FALSE, fig.width=7, fig.cap="Scatterplot showing association betweeen chlorophyll \\textit{a} and microcystin-LR. \\label{fig:chla_micro_scatter}"}
...
```{r epa_child_cp_plot, echo=FALSE, fig.width=7, fig.cap="Conditional probability plots showing association between the probability of exceeding various microcystin-LR (MLR) health advisory Levels. \\label{fig:multi_cp_plot}"}
multiplot(
