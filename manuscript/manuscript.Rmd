...
```{r mc_chla_table, results='asis', echo=FALSE, tab.cap="Chlorophyll \textit{a} concentrations that are associated with a 50 percent probability of exceeding a microcystin-LR health advisory concentration. \\label{tab:mc_chla_table}"}
